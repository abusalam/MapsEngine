...
if (file_exists('config.inc.php')) {
  require_once 'config.inc.php'; //Include the nested sql.defs.php don't use __DIR__
}

if (file_exists(__DIR__ . '/MySQLiDB.inc.php')) {
  require_once __DIR__ . '/MySQLiDB.inc.php';
}
require_once __DIR__ . '/class.MySQLiDBHelper.php';
if (file_exists('sql.defs.php')) {
...
class WebLib {
  ...
  public static function PageInfo() {
    ...
    if (count($Visits) > 0) {
      ...
      $reg->insert(MySQL_Pre . 'Visits', array('PageURL' => $_SERVER['PHP_SELF'],
